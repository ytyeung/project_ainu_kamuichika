...
async function loadPages() {
    ...
    try {
        const pageDataUrls = [
            'json/eng/Chiri_Yukie_Prologue_eng.json',
            'json/eng/1_Kamuichikap_Shirokanipe_eng.json',
            'json/eng/2_Chironnup_Towa_eng.json',
            'json/eng/3_Chironnup_Haikunterke_eng.json',
            'json/eng/4_Isepo_Sampaya_eng.json',
            'json/eng/5_Nitatorunpe_Harit_eng.json',
            'json/eng/6_Pon_Hotenao_eng.json',
            'json/eng/7_Kamuichikap_Konkuwa_eng.json',
            'json/eng/8_Repun_Atuika_eng.json',
            'json/eng/9_Terkepi_Tororo_eng.json',
            'json/eng/10_Pon_Kutnisa_eng.json',
